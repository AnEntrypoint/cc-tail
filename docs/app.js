...
const INSTALL = 'npm install ccsniff';
...
function Topbar() {
    ...
    return h('header', { class: 'app-topbar' },
        h('span', { class: 'brand' }, '247420', h('span', { class: 'slash' }, ' / '), 'ccsniff'),
        h('nav', {},
...
function Crumb() {
    return h('div', { class: 'app-crumb' },
        ...
        h('span', {}, 'ccsniff'), h('span', { class: 'sep' }, '›'),
...
const ESM_SNIPPET =
`<span class="k">import</span> { watch } <span class="k">from</span> <span class="s">'ccsniff'</span>;
...
function Overview() {
    return [
        ...
        h('h3', { id: 'demo' }, 'demo'),
        h('p', {}, 'this is what ccsniff emits when claude code runs. synthetic stream, loops forever.'),
        DemoSection()
    ];
}
